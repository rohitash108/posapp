...
function mkS(c: ThemeColors, isDark: boolean) {
  return StyleSheet.create({
    ...
    aggBannerTitle: { fontSize: 16, fontWeight: '800', color: '#fff', letterSpacing: 0.2 },
    aggBannerSub:   { fontSize: 14, color: 'rgba(255,255,255,0.85)', marginTop: 3 },
    ...
    statLabel:      { fontSize: 13, fontWeight: '600', color: c.textMuted, marginBottom: 5, textTransform: 'uppercase', letterSpacing: 0.5 },
    statNum:        { fontSize: 24, fontWeight: '900', color: c.heading, letterSpacing: -1.2 },
    ...
    tabPillTxt:     { fontSize: 16, fontWeight: '600', color: c.heading },
    tabCount:       {
    ...
    tabCountTxt:    { fontSize: 12, fontWeight: '800', color: c.text },
    ...
    emptySub:       { fontSize: 14, color: c.textMuted, textAlign: 'center', paddingHorizontal: 40, lineHeight: 21 },
...
function mkDd(c: ThemeColors) {
  return StyleSheet.create({
    ...
    headerTitle: { fontSize: 16, fontWeight: '800', color: c.heading },
    headerSub:   { fontSize: 14, color: c.textMuted, marginTop: 2 },
    ...
    itemLabel:   { flex: 1, fontSize: 16, fontWeight: '600', color: c.heading },
...
function mkCd(c: ThemeColors, isDark: boolean) {
  ...
  return StyleSheet.create({
    ...
    headSub:     { fontSize: 16, color: c.textMuted, marginTop: 3 },
    ...
    time:        { fontSize: 14, color: c.textMuted, fontWeight: '500', flexShrink: 1, textAlign: 'right' },
    ...
    moreItems:   { fontSize: 14, fontWeight: '700', color: c.primary, marginTop: 5 },
    ...
    notesText:   { flex: 1, fontSize: 14, color: notesText, lineHeight: 20 },
    riderBox:    { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: riderBg, borderRadius: 10, padding: 9, marginTop: 7 },
    riderText:   { flex: 1, fontSize: 14, color: riderText, lineHeight: 20 },
    ...
    outlineOrangeTxt: { fontSize: 14, fontWeight: '700', color: S.warning },
    ...
    solidPrimaryTxt:  { fontSize: 14, fontWeight: '700', color: '#fff' },
    ...
    outlineNeutralTxt:{ fontSize: 14, fontWeight: '700', color: isDark ? '#fff' : c.heading },
    ...
    payLabel:    { fontSize: 14, fontWeight: '700', color: S.warning },
    ...
    pmText:      { fontSize: 14, fontWeight: '700', color: S.warning },
    ...
    markPaidTxt:   { fontSize: 14, fontWeight: '700', color: '#fff' },
    ...
    markUnpaidTxt: { fontSize: 14, fontWeight: '700', color: S.warning },
    statusPill:  {
      flexDirection: 'row', alignItems: 'center', gap: 5,
    ...
    rejectTxt:   { fontSize: 14, fontWeight: '700', color: c.danger },
  });
}
...
function mkLr(c: ThemeColors, isDark: boolean) {
  ...
  return StyleSheet.create({
    ...
    hCell:     { fontSize: 14, fontWeight: '800', color: c.textMuted, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    customer:  { fontSize: 16, fontWeight: '600', color: c.heading },
    type:      { fontSize: 16, color: c.text, fontWeight: '600' },
    ...
    pmBtnLast:   { borderRightWidth: 0 },
    pmBtnActive: { backgroundColor: c.primary, borderRightColor: c.primary },
    pmTxt:       { fontSize: 14, fontWeight: '700', color: S.warning },
    ...
    printBtnTxt: { fontSize: 14, fontWeight: '700', color: '#fff' },
...
function mkMs(c: ThemeColors) {
  return StyleSheet.create({
    ...
    title:        { fontSize: 20, fontWeight: '800', color: c.heading, paddingHorizontal: 18, paddingTop: 4, paddingBottom: 2 },
    sub:          { fontSize: 14, color: c.textMuted, paddingHorizontal: 18, paddingBottom: 8 },
    ...
    itemTxt:      { flex: 1, fontSize: 16, color: c.text, fontWeight: '600' },
