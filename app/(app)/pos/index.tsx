...
function mkCpm(c: _TC) { return StyleSheet.create({
  ...
  legendText:  { fontSize: 14, color: '#d97706', flex: 1 },
...
function mkMb(c: _TC) { return StyleSheet.create({
  ...
  topTitle:   { fontSize: 24, fontWeight: '800', color: c.heading, lineHeight: 30 },
  topSub:     { fontSize: 14, color: c.textMuted, marginTop: 1 },
  ...
  searchInput:{ flex: 1, fontSize: 16, color: c.heading, padding: 0 },
  ...
  fabTotal:   { color: c.brand, fontWeight: '800', fontSize: 16 },
}); }
...
function mkMc(c: _TC) { return StyleSheet.create({
  ...
  orderTypePillText:    { fontSize: 16, fontWeight: '600', color: c.textMuted },
  ...
  ctxChipText:          { fontSize: 14, fontWeight: '500', color: c.textMuted, maxWidth: 100 },
  ...
  itemsHeaderTitle:     { fontSize: 16, fontWeight: '800', color: c.heading, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  emptyCartText:        { fontSize: 20, fontWeight: '700', color: c.text },
  emptyCartSub:         { fontSize: 14, color: c.textMuted },
  ...
  cartItemName:         { fontSize: 16, fontWeight: '600', color: c.heading },
  ...
  qtyText:              { fontSize: 14, fontWeight: '700', color: c.heading, minWidth: 24, textAlign: 'center' },
  cartItemTotal:        { fontSize: 14, fontWeight: '800', color: '#0D76E1', minWidth: 52, textAlign: 'right' },
  ...
  sectionLabel:         { fontSize: 16, fontWeight: '800', color: c.textMuted, letterSpacing: 0.8, textTransform: 'uppercase', marginBottom: 7 },
  ...
  summaryVal:           { fontSize: 14, fontWeight: '600', color: c.text },
...
function mkSu(c: _TC) { return StyleSheet.create({
  ...
  title:       { fontSize: 24, fontWeight: '800', color: c.heading },
  orderNum:    { fontSize: 15, fontWeight: '700', color: c.brand, marginBottom: 8 },
  hint:        { fontSize: 16, color: '#d97706', lineHeight: 22, marginBottom: 16 },
  ...
  kotText:     { fontSize: 16, fontWeight: '700', color: c.heading },
  ...
  billText:    { fontSize: 16, fontWeight: '700', color: '#fff' },
  ...
  closeText:   { fontSize: 16, fontWeight: '800', color: '#fff' },
}); }
