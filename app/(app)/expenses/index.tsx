...
function mkS(c: ThemeColors) {
  return StyleSheet.create({
    // Header
    header:        { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10, paddingHorizontal: 16, paddingTop: 14, paddingBottom: 12, backgroundColor: c.surface, borderBottomWidth: 1, borderBottomColor: c.border },
    ...
    outlineBtn:    { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 8, borderWidth: 1.5, borderColor: c.border, backgroundColor: c.surface },
    outlineBtnTxt: { fontSize: 13, fontWeight: '700', color: c.text },
    goldOutlineBtn:{ flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 8, borderWidth: 1.5, borderColor: c.brand, backgroundColor: c.surface },
    goldOutlineTxt:{ fontSize: 13, fontWeight: '700', color: c.brand },
    addBtn:        { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: c.sidebar, borderRadius: 8, paddingHorizontal: 14, paddingVertical: 8 },
    ...
    statCardBorder:{ borderLeftWidth: 1, borderLeftColor: c.border },
    statCardTop:   { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 6 },
    statCardLbl:   { fontSize: 11, fontWeight: '700', color: c.textMuted, textTransform: 'uppercase', letterSpacing: 0.4 },
    statCardAmt:   { fontSize: 20, fontWeight: '800', color: c.heading },

    // Filter bar
    filterBar:     { flexDirection: 'row', alignItems: 'flex-end', flexWrap: 'wrap', gap: 10, backgroundColor: c.surface, paddingHorizontal: 14, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: c.border },
    filterField:   { gap: 4, position: 'relative' },
    filterLbl:     { fontSize: 10.5, fontWeight: '700', color: c.textMuted, textTransform: 'uppercase', letterSpacing: 0.4 },
    filterInput:   { borderWidth: 1, borderColor: c.border, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 7, fontSize: 13, color: c.heading, minWidth: 120 },
    filterDropBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, borderWidth: 1, borderColor: c.border, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, backgroundColor: c.surface, minWidth: 130 },
    filterDropTxt: { flex: 1, fontSize: 13, color: c.text },
    searchBox:     { flexDirection: 'row', alignItems: 'center', gap: 6, borderWidth: 1, borderColor: c.border, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 7, backgroundColor: c.surface, minWidth: 140 },
    searchInput:   { flex: 1, fontSize: 13, color: c.heading, padding: 0 },
    filterBtn:     { backgroundColor: c.sidebar, borderRadius: 8, paddingHorizontal: 18, paddingVertical: 8, alignSelf: 'flex-end' },
    filterBtnTxt:  { color: '#fff', fontWeight: '700', fontSize: 13 },
    resetBtn:      { borderWidth: 1.5, borderColor: c.brand, borderRadius: 8, paddingHorizontal: 14, paddingVertical: 7, alignSelf: 'flex-end' },
    resetBtnTxt:   { color: c.brand, fontWeight: '700', fontSize: 13 },

    // Dropdown
    dropMenu:       { position: 'absolute', top: 60, left: 0, minWidth: 160, zIndex: 999, backgroundColor: c.surface, borderRadius: 10, borderWidth: 1, borderColor: c.border, shadowColor: '#000', shadowOpacity: 0.12, shadowRadius: 12, elevation: 10, overflow: 'hidden' },
    dropItem:       { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 12, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: c.border },
    dropItemActive: { backgroundColor: c.surfaceAlt },
    dropItemTxt:    { flex: 1, fontSize: 13, color: c.text },
    dropItemTxtActive: { fontWeight: '700', color: c.sidebar },
    ...
    resultAmt:   { fontSize: 12, fontWeight: '800', color: c.text },
    ...
    emptyTitle:  { fontSize: 14, fontWeight: '600', color: c.brand, textAlign: 'center', paddingHorizontal: 40 },
    emptyAddBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: c.sidebar, borderRadius: 10, paddingHorizontal: 18, paddingVertical: 10 },
...
function mkEc(c: ThemeColors) {
  return StyleSheet.create({
    card:       { backgroundColor: c.surface, borderRadius: 14, padding: 14, borderLeftWidth: 4, borderWidth: 1, borderColor: c.border, shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
    top:        { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
    title:      { fontSize: 15, fontWeight: '700', color: c.heading },
    ...
    dateTxt:    { fontSize: 11.5, color: c.textMuted },
    amount:     { fontSize: 18, fontWeight: '900', color: c.brand, flexShrink: 0 },
    metaExtra:  { flexDirection: 'row', flexWrap: 'wrap', gap: 5, marginTop: 7 },
    pmBadge:    { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 5, backgroundColor: c.surfaceAlt, borderWidth: 1, borderColor: c.border },
    pmTxt:      { fontSize: 10, color: c.textMuted, fontWeight: '600' },
    notes:      { fontSize: 12, color: c.textMuted, marginTop: 8, fontStyle: 'italic', lineHeight: 17 },
...
function mkFm(c: ThemeColors) {
  return StyleSheet.create({
    ...
    prefixSymbol:{ fontSize: 15, fontWeight: '800', color: c.textMuted },
    ...
    catChip:         { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 11, paddingVertical: 7, borderRadius: 10, backgroundColor: c.surfaceAlt, borderWidth: 1.5, borderColor: c.border },
    catChipSelected: { backgroundColor: c.sidebar, borderColor: c.sidebar },
    catDot:          { width: 7, height: 7, borderRadius: 3.5 },
    catChipTxt:      { fontSize: 12.5, fontWeight: '600', color: c.text },
    catEmptyHint:    { flexDirection: 'row', alignItems: 'center', gap: 6, paddingVertical: 8, paddingHorizontal: 4 },
    catEmptyTxt:     { fontSize: 12, color: c.textMuted, fontStyle: 'italic', flex: 1 },

    pmGrid:          { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 2 },
    pmChip:          { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 11, paddingVertical: 8, borderRadius: 10, backgroundColor: c.surfaceAlt, borderWidth: 1.5, borderColor: c.border },
    pmChipActive:    { backgroundColor: 'rgba(201,165,42,0.08)', borderColor: c.brand },
    pmChipTxt:       { fontSize: 12.5, fontWeight: '600', color: c.text },
    pmChipTxtActive: { color: c.brand, fontWeight: '700' },

    preview:     { backgroundColor: c.surfaceAlt, borderRadius: 12, padding: 14, borderWidth: 1, borderColor: c.border },
    previewLbl:  { fontSize: 10, fontWeight: '800', color: c.textMuted, textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 8 },
    previewRow:  { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    previewTitle:{ fontSize: 14, fontWeight: '700', color: c.heading, flex: 1 },
    previewAmt:  { fontSize: 18, fontWeight: '900', color: c.brand },
    previewDate: { fontSize: 12, color: c.textMuted, marginTop: 4 },
    ...
    attachBox:   { flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1.5, borderColor: c.border, borderStyle: 'dashed', borderRadius: 11, padding: 14, backgroundColor: c.surfaceAlt },
    attachTxt:   { fontSize: 13, fontWeight: '600', color: c.textMuted },
    attachHint:  { fontSize: 11, color: c.border, marginTop: 1 },

    recurringRow:    { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14, borderRadius: 12, borderWidth: 1.5, borderColor: c.border, backgroundColor: c.surfaceAlt },
    checkbox:        { width: 22, height: 22, borderRadius: 6, borderWidth: 2, borderColor: c.border, alignItems: 'center', justifyContent: 'center', backgroundColor: c.surface },
    checkboxChecked: { backgroundColor: c.sidebar, borderColor: c.sidebar },
    recurringLabel:  { fontSize: 14, fontWeight: '700', color: c.text },
    recurringHint:   { fontSize: 11.5, color: c.textMuted, marginTop: 2 },
    ...
    recurringBadgeTxt: { fontSize: 11, fontWeight: '700', color: c.brand },
...
function mkDm(c: ThemeColors) {
  return StyleSheet.create({
    backdrop:   { flex: 1, backgroundColor: 'rgba(0,0,0,0.45)', alignItems: 'center', justifyContent: 'center', padding: 24 },
    panel:      { backgroundColor: c.surface, borderRadius: 20, width: '100%', maxWidth: 340, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 30, elevation: 20 },
    iconWrap:   { alignItems: 'center', paddingTop: 28, paddingBottom: 4 },
    title:      { fontSize: 18, fontWeight: '800', color: c.heading, textAlign: 'center', marginTop: 10, paddingHorizontal: 24 },
    body:       { fontSize: 13.5, color: c.textMuted, textAlign: 'center', marginTop: 7, lineHeight: 20, paddingHorizontal: 24, paddingBottom: 22 },
    divider:    { height: 1, backgroundColor: c.border },
    btnRow:     { flexDirection: 'row' },
    cancelBtn:  { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 15, borderRightWidth: 1, borderRightColor: c.border },
      ...
      <View style={fm.header}>
        <View style={fm.headerLeft}>
          <View style={fm.headerIcon}>
            <Ionicons name={isEdit ? 'pencil' : 'wallet'} size={16} color={c.brand} />
          </View>
          <View>
          ...
          <View style={[fm.field, { flex: 1.6 }]}>
            ...
            <View style={[fm.inputWrap, !!errors.title && fm.inputError]}>
              <View style={fm.inputPrefix}>
                <Ionicons name="receipt-outline" size={15} color={c.textMuted} />
              </View>
              <TextInput
                style={fm.input}
                value={form.title}
            ...
            {PAYMENT_METHODS.map(m => {
              ...
              return (
                <Pressable
                  ...
                  <Ionicons name={m.icon as any} size={14} color={active ? c.brand : c.textMuted} />
        ...
        <View style={fm.field}>
          ...
          <View style={fm.catGrid}>
            <Pressable
              ...
              <Ionicons name="grid-outline" size={12} color={!form.category_id ? '#fff' : c.textMuted} />
          ...
          <Pressable style={fm.recurringRow} onPress={() => toggle('is_recurring')}>
            ...
            {form.is_recurring && (
              <View style={fm.recurringBadge}>
                <Ionicons name="repeat-outline" size={12} color={c.brand} />
        ...
        {form.amount && !isNaN(parseFloat(form.amount)) && parseFloat(form.amount) > 0 ? (
          <View style={fm.preview}>
            ...
            <View style={fm.previewRow}>
              ...
              <View style={{ alignItems: 'flex-end' }}>
                ...
                {form.tax_amount && parseFloat(form.tax_amount) > 0
                  ? <Text style={{ fontSize: 11, color: c.textMuted }}>+₹{parseFloat(form.tax_amount).toFixed(2)} tax</Text>
                  : null}
              </View>
            </View>
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 6 }}>
              ...
              {form.category_id
                ? <Text style={fm.previewDate}>· {categories.find(cat => String(cat.id) === form.category_id)?.name ?? ''}</Text>
                : null}
              {form.payment_method
                ? <Text style={fm.previewDate}>· {PAYMENT_METHODS.find(m => m.value === form.payment_method)?.label}</Text>
                : null}
              {form.is_recurring
                ? <Text style={[fm.previewDate, { color: c.brand }]}>· Recurring</Text>
                : null}
            </View>
          </View>
        ) : null}
    ...
    <Modal transparent animationType="fade" visible onRequestClose={onCancel}>
      <Pressable style={dm.backdrop} onPress={() => !deleting && onCancel()}>
        <Pressable style={dm.panel} onPress={() => {}}>
          ...
          <Text style={dm.body}>
            "<Text style={{ fontWeight: '700', color: c.text }}>{expense.title}</Text>" will be permanently removed.
          </Text>
  ...
  return (
    <View style={[ec.card, { borderLeftColor: pal.dot }]}>
      <View style={ec.top}>
        ...
        <View style={{ alignItems: 'flex-end' }}>
          ...
          {e.tax_amount && e.tax_amount > 0
            ? <Text style={{ fontSize: 10, color: c.textMuted, marginTop: 1 }}>+₹{e.tax_amount.toFixed(2)} tax</Text>
            : null}
        </View>
      </View>
      {/* Extra meta */}
      <View style={ec.metaExtra}>
        ...
        {e.receipt_number ? (
          <View style={ec.pmBadge}>
            <Ionicons name="document-text-outline" size={10} color={c.textMuted} />
        ...
        {e.is_recurring ? (
          <View style={[ec.pmBadge, { backgroundColor: 'rgba(201,165,42,0.1)', borderColor: 'rgba(201,165,42,0.3)' }]}>
            <Ionicons name="repeat-outline" size={10} color={c.brand} />
            <Text style={[ec.pmTxt, { color: c.brand }]}>Recurring</Text>
          </View>
        ) : null}
      </View>
      {e.notes ? (
        <Text style={ec.notes} numberOfLines={2}>
          <Ionicons name="chatbubble-ellipses-outline" size={11} color={c.border} /> {e.notes}
        </Text>
      ) : null}
...
export default function ExpensesScreen() {
  ...
  function getCatIdx(e: Expense) { return categories.findIndex(cat => cat.id === e.category_id); }
  ...
  const selectedCatName = catFilter ? (categories.find(cat => String(cat.id) === catFilter)?.name ?? 'Category') : 'All Categories';
  const selectedPmName  = pmFilter  ? (PAYMENT_METHODS.find(m => m.value === pmFilter)?.label ?? 'Method') : 'All Methods';

  return (
    <Pressable style={{ flex: 1, backgroundColor: c.background }} onPress={() => { setCatOpen(false); setPmOpen2(false); }}>
      ...
      <View style={s.statsRow}>
        <View style={s.statCard}>
          <View style={s.statCardTop}>
            ...
            <Text style={[s.statCardLbl, { color: c.brand }]}>Period Total</Text>
          </View>
          <Text style={[s.statCardAmt, { color: c.brand }]}>₹{periodTotal.toFixed(2)}</Text>
        </View>
        <View style={[s.statCard, s.statCardBorder]}>
          <View style={s.statCardTop}>
            <Ionicons name="receipt-outline" size={20} color={c.brand} />
            <Text style={[s.statCardLbl, { color: c.brand }]}>Tax Paid</Text>
          </View>
          <Text style={[s.statCardAmt, { color: c.brand }]}>₹{taxPaid.toFixed(2)}</Text>
        </View>
        <View style={[s.statCard, s.statCardBorder]}>
          <View style={s.statCardTop}>
            <Ionicons name="today-outline" size={20} color={c.textMuted} />
      ...
      <View style={s.filterBar}>
        ...
        <View style={s.filterField}>
          ...
          {Platform.OS === 'web' ? (
            <input type="date" value={dateFrom}
              ...
              style={{ border: `1px solid ${c.border}`, borderRadius: 8, padding: '6px 10px', fontSize: 13, color: c.heading, backgroundColor: c.surface, cursor: 'pointer', outline: 'none' } as any} />
          ) : (
            <TextInput style={s.filterInput} value={dateFrom} onChangeText={setDateFrom} placeholder="YYYY-MM-DD" placeholderTextColor={c.textMuted} />
          )}
        </View>
        <View style={s.filterField}>
          ...
          {Platform.OS === 'web' ? (
            ...
            <TextInput style={s.filterInput} value={dateTo} onChangeText={setDateTo} placeholder="YYYY-MM-DD" placeholderTextColor={c.textMuted} />
          )}
        </View>
        ...
        <View style={[s.filterField, { zIndex: 100 }]}>
          ...
          <Pressable style={s.filterDropBtn} onPress={e => { e.stopPropagation?.(); setCatOpen(p => !p); setPmOpen2(false); }}>
            ...
            <Ionicons name={catOpen ? 'chevron-up' : 'chevron-down'} size={13} color={c.textMuted} />
          </Pressable>
          {catOpen && (
            <View style={s.dropMenu}>
              <Pressable style={[s.dropItem, !catFilter && s.dropItemActive]} onPress={() => { setCatFilter(''); setCatOpen(false); }}>
                ...
                {!catFilter && <Ionicons name="checkmark" size={13} color={c.sidebar} />}
              </Pressable>
              {categories.map(cat => (
                <Pressable key={cat.id} style={[s.dropItem, catFilter === String(cat.id) && s.dropItemActive]}
                  onPress={() => { setCatFilter(String(cat.id)); setCatOpen(false); }}>
                  <Text style={[s.dropItemTxt, catFilter === String(cat.id) && s.dropItemTxtActive]}>{cat.name}</Text>
                  {catFilter === String(cat.id) && <Ionicons name="checkmark" size={13} color={c.sidebar} />}
                </Pressable>
              ))}
            </View>
          )}
        ...
        <View style={[s.filterField, { zIndex: 99 }]}>
          ...
          <Pressable style={s.filterDropBtn} onPress={e => { e.stopPropagation?.(); setPmOpen2(p => !p); setCatOpen(false); }}>
            ...
            <Ionicons name={pmOpen2 ? 'chevron-up' : 'chevron-down'} size={13} color={c.textMuted} />
          </Pressable>
          {pmOpen2 && (
            <View style={s.dropMenu}>
              <Pressable style={[s.dropItem, !pmFilter && s.dropItemActive]} onPress={() => { setPmFilter(''); setPmOpen2(false); }}>
                ...
                {!pmFilter && <Ionicons name="checkmark" size={13} color={c.sidebar} />}
              </Pressable>
              {PAYMENT_METHODS.map(m => (
                <Pressable key={m.value} style={[s.dropItem, pmFilter === m.value && s.dropItemActive]}
                  onPress={() => { setPmFilter(m.value); setPmOpen2(false); }}>
                  <Ionicons name={m.icon as any} size={13} color={pmFilter === m.value ? c.sidebar : c.textMuted} />
                  <Text style={[s.dropItemTxt, pmFilter === m.value && s.dropItemTxtActive]}>{m.label}</Text>
                  {pmFilter === m.value && <Ionicons name="checkmark" size={13} color={c.sidebar} />}
                </Pressable>
              ))}
            </View>
          )}
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={s.emptyWrap}>
              <Ionicons name="wallet-outline" size={44} color={c.brand} />
